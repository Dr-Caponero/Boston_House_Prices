...
Na análise da Figura 20, onde os resíduos foram padronizados, verifica-se queo número de observações além do limite de aceitação aumentou consideravelmente, inclusive o limite inferior tanbém foi ultrapassado.
...
A Figura 23 apresenta os DFBetas para cada uma das variáveis utilizadas no modelo. Nota-se que as observações já identificadas como anômalas pelos gráficos anteriores se repetem com maior frequência na Figura 15.
