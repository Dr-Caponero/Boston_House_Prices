...
# Dispersão ----
{
  ## d1 age ----
  d1 <- dados|>
    ggplot(aes(y = medv, x = age, color = "#234B6E")) +
    geom_point()+
    labs(
    ...
    geom_smooth(method=lm, se=T, color="tomato")+
    theme_minimal(base_size = 7.5)
